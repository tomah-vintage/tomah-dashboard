  ...
  const bannerTypes = [
    {
      ...
      title: "Hero баннер",
      description:
        "Том нүүр хуудасны баннер - таны ресторанаа нээх бүртээ анхны зүйл",
      icon: Monitor,
      features: ["Хамгийн том хэмжээ", "Дурын зураг", "Анимейшн дэмжлэг"],
    },
    {
      type: BannerLayoutType.Carousel,
      title: "Carousel баннер",
      description: "Олон баннерыг ээлжлэн гүйлгэх боломж",
      icon: RotateCcw,
      features: ["Олон зураг", "Автомат ээлжлэл", "Хэрэглэгчийн удирдлага"],
    },
    {
      type: BannerLayoutType.Magazine,
      title: "Magazine баннер",
      description: "Сэтгүүлийн төрлийн баннер - блог, мэдээ, түүх",
      icon: BookOpen,
      features: ["Контент баннер", "Мэдээ мэдээлэл", "Түүх ярих"],
    },
  ];
  ...
  <DialogContent class_="max-w-7xl w-[95vw]">
    ...
    <div class="p-6">
      <p class="text-gray-600 mb-6">
        Таны ресторанд тохирох баннерын төрлийг сонгоно уу
      </p>
