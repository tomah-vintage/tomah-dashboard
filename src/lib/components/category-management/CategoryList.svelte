<script lang="ts">
  ...
  // Removed allChecked and related functions as checkboxes are being removed
</script>

<div class="w-full text-sm">
  <!-- Table Header -->
  <div class="flex items-center px-4 py-3 border-b border-gray-200 rounded-t-lg bg-gray-50">
  ...
  <div>
    {#each categories as category (category.id)}
      <div class="flex items-center px-4 py-4 border-b border-gray-100 hover:bg-gray-50">
        <div class="flex-1 font-medium text-gray-800">{category.name}</div>
        <div class="w-48 text-gray-600">{category.count || 0}</div>
...
<div class="flex items-center justify-between mt-4 text-sm">
  ...
  <div class="flex items-center space-x-2 text-gray-500">
    <button class="p-1.5 rounded-md hover:bg-gray-100 disabled:text-gray-300" disabled>
